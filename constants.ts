...
:root {
    ...
    --bg-overlay: rgba(255, 255, 255, 0.90); /* Blur backdrop */
    --border-subtle: rgba(0, 0, 0, 0.05); /* Whisper thin border */
    
    /* --- TYPOGRAPHY --- */
    --text-primary: #1D1D1F; /* Soft Black - Crisp but not harsh */
    --text-secondary: #6E6E73; /* Cool Gray - Lucid information */
    ...
    --shadow-lg: 0 12px 24px -6px rgba(0, 0, 0, 0.08), 0 4px 8px -4px rgba(0, 0, 0, 0.03);
    ...
    --sidebar-width: 240px;
    --radius-pill: 9999px;
    --radius-card: 16px; /* Relaxed corners */
}
